...
# # Term: Winter 2019
# # Autogenerated from: "04. Functions.ipynb"
# # 
...
# # In Python a function is some reusable code that takes one or more arguments as input, does some computation, and then returns one or more results. We define a function using the def reserved word. We call/invoke the function by using the function name, parentheses, and arguments in an expression (cite: Dr. Chuck's PowerPoint).
# # 
