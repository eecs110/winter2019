...
<table class="tbl-files">
    <tbody>
        ...
        <tr>
            ...
            <td align="right">1/5/2019 12:46 AM</td>
            <td>256.0B</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td align="right">1/4/2019 7:36 PM</td>
            <td>5.5KB</td>
            <td>
                <i class="fab fa-github"></i> 
                <a href="https://github.com/eecs110/winter2019/blob/master/course-files/homework/hw1.zip" target="_blank">
                    preview
                </a>
            </td>
        </tr>
